#!/usr/bin/env python3
"""
GreeksView Confluence Publisher: Product Specification: Intraday EdgeMatrix™
=============================================================================
Publishes Intraday EdgeMatrix™ specification to Atlassian Confluence Cloud under Space SD.
Parent Page: Quantitative Research: AAPL 5-Minute Intraday Structure, Gap Dynamics & Repeatable Alpha Patterns (ID: 18612225)
"""
...
PARENT_PAGE_ID = "18612225"
PAGE_TITLE = "Product Specification: Intraday EdgeMatrix™ — Real-Time 5-Minute Pattern Scanner, SEO Strategy & 0DTE Options Playbook"
DOC_PATH = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
    "docs",
    "confluence",
    "intraday-edgematrix-product-specification.md",
)
