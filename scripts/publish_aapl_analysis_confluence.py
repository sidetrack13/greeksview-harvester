#!/usr/bin/env python3
"""
GreeksView Confluence Publisher: AAPL 5-Minute Intraday Alpha & Repeatable Patterns
==================================================================================
Publishes document to Atlassian Confluence Cloud under Space SD.
Parent Page: Operational Runbook: GreeksView Harvester Architecture & Multi-Universe Ingestion Engine (ID: 18186241)
"""
...
PARENT_PAGE_ID = "18186241"
PAGE_TITLE = "Quantitative Research: AAPL 5-Minute Intraday Structure, Gap Dynamics & Repeatable Alpha Patterns"
DOC_PATH = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
    "docs",
    "confluence",
    "aapl-5min-intraday-patterns-analysis.md",
)


def load_env():
    # Look in greeksview or greeksview-harvester
    candidates = [
